export default function Service() {
  return (
    <section className="py-8 lg:py-11" id="service">
      <h3 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-center pb-6 lg:pb-11">services</h3>
      <div className="container mx-auto p-4 lg:p-5 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-5">
        <div className="p-4 lg:p-5 rounded-xl mx-auto hover:shadow-3xl hover:scale-105 lg:hover:scale-110 bg-white w-full max-w-sm">
          <div className="rounded-full mx-auto">
            <img
              src="image/service/1.png"
              alt="Mobile Repair"
              className="w-24 h-24 sm:w-32 sm:h-32 lg:w-36 lg:h-36 mx-auto"
            />
          </div>
          <h3 className="text-xl sm:text-2xl font-bold text-center py-4 lg:py-5">
            Mobile Repairs and Servicing
          </h3>
          <p className="font-light text-justify text-sm sm:text-base">
