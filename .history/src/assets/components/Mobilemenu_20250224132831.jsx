    ...
    <div
      ...
      <ul className="grid grid-cols-1 gap-3 text-2xl text-center w-1/2 mx-auto ">
        <li className="uppercase font-bold hover:border-b-2 border-blue-400">
          Home              <a href="#hero">Home</a>
        </li>
        <li className="uppercase font-bold hover:border-b-2 border-blue-400">
          About              <a href="#banner">About Us</a>
        </li>
        <li className="uppercase font-bold hover:border-b-2 border-blue-400">
          Service              <a href="#service">Services</a>
        </li>
        <li className="uppercase font-bold hover:border-b-2 border-blue-400">
          Product              <a href="#toplist">Products</a>
        </li>
        <li className="uppercase font-bold hover:border-b-2 border-blue-400">
          Contact-Us              <a href="#contact">Contact Us</a>
        </li>
      </ul>
    </div>
  );
